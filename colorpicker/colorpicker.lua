...
local gWindowTitlebarButtons = {
	defaultColour = {160, 160, 160},
	defaultDivider = "|",
}

local function guiWindowTitlebarButtonAdd(window, text, alignment, onClick, ...)
...
colorPicker = {
	...
	constructor = function( info )
		...
		colorPicker.GUI.selectWindow = guiCreateWindow((screenW - info.selectWindow.width) / 2, (screenH - info.selectWindow.height) / 2,
		                                        info.selectWindow.width, info.selectWindow.height, "Selecciona un color", false)
		guiSetVisible(colorPicker.GUI.selectWindow, false)
		guiWindowSetSizable(colorPicker.GUI.selectWindow, false)
		
		guiWindowTitlebarButtonAdd(colorPicker.GUI.selectWindow, "Cerrar", "right", function() colorPicker.closeSelect(true) end)
		guiWindowTitlebarButtonAdd(colorPicker.GUI.selectWindow, "Aceptar", "left", function() colorPicker.closeSelect() end)
